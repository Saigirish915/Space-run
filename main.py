...
# def player including animated states
def draw_player():
    ...
    if player_y < init_y or pause:
        if booster:
            ...
            pygame.draw.ellipse(screen, 'orange', [105, player_y + 50, 20, 30])
...
def draw_pause():
    ...
    surface.blit(font.render('Game Paused. Escape Btn Resume', True, 'black'), (220, 160))
